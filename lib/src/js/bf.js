            ...
            if (schema.hasOwnProperty("oneOf")) {
                ...
                if (schema.properties) {
                    ...
                    if (schema.hasOwnProperty("dependencies")) {
                        schema.dependenciesProperties = schema.dependencies;
            ...
            if (schema.hasOwnProperty("oneOf")) {
                ...
                if (schema.properties) {
                    ...
                    for (var prop in schema.properties) {
                        ...
                        //// JSC
                        if (schema.dependenciesProperties) {
                            for (var key in schema.dependenciesProperties) {
                                if (key == prop) {
                                    subSchema.requiredIf = schema.dependenciesProperties[key];
                                }
                            }
                        }
                        ///// end JSC
