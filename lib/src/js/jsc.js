		...
		function receivedText(e) {
			...
			try {
				...
				if ($("[data-project='" + project + "']").length > 0) {
					alertify.prompt( 'Project exists', 'This project name already exists. Using the same name will overwrite he previous configuration. Do you wish to rename?', project
				   , function(evt, value) { formInit(value, config, buttons); }
				   , function() {});
			   } else {
